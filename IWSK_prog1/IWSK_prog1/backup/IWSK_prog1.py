...
class UARTApp:
    ...
    def setup_ui(self):
        ...
        # Format znaku (Bity danych, Parzystoœæ, Bity stopu)
    ...
    def connect_serial(self):
        ...
        try:
            ...
            self.serial_port = serial.Serial(
                ...
                rtscts=rtscts,
                dsrdtr=dsrdtr,
                timeout=0 # Non-blocking do pêtli zdarzeñ UI
            )
        ...
        if self.serial_port and self.serial_port.is_open:
            ...
            if data_str:
                ...
                try:
                    ...
                    self.txt_tx.delete("1.0", tk.END) # Wyczyœæ bufor po wys³aniu
                except Exception as e:
    ...
    def send_ping(self):
        if self.serial_port and self.serial_port.is_open:
            ...
            # Wysy³amy specjaln¹ sekwencjê. Drugi program musi na ni¹ odpowiedzieæ.
        ...
        if self.serial_port and self.serial_port.is_open:
            try:
                ...
                if data:
                    ...
                    # Automatyczna odpowiedŸ na PING (dla testowania z drugim komputerem)
                    ...
                    # Odbiór PONG i obliczenie opóŸnienia
